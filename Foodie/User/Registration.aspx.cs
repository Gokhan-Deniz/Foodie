    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuUserImage.HasFile)
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Görseli .jpg, .jpeg veya .png olarak seçiniz.";
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                        "kayıt oldunuz <b><a href='Login.aspx'>Giriş Yap</a></b>":
                        "başarıyla güncellediniz <b><a href='Profile.aspx'>Kontrol edebilirsiniz</a></b>";
                    lblMsg.Visible = true;
                ...
                {
                    if(ex.Message.Contains("Daha önce alınmamışından al"))
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUsername.Text.Trim() + "</b> kullanıcı adı alındı.";
                        lblMsg.CssClass = "alert alert-danger";
                    }
                }
                catch(Exception ex)
