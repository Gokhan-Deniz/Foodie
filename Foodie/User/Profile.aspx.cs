...
namespace Foodie.User
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        void getPurchaseHistory()
        {
            ...
            //cmd.Parameters.AddWithValue("@Status", e.CommandArgumants);
            cmd.Parameters.AddWithValue("@UserId", Session["userId"]);
            cmd.CommandType = CommandType.StoredProcedure;
            sda = new SqlDataAdapter(cmd);
            dt = new DataTable();
        ...
        private sealed class CustomTemplate : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td><b>Neden alışveriş yapmıyorsun???</b><a href='Menu.aspx' class='badge badge-info ml-2'> Alışverişe Devam Et</a></td></tr></tbody></table>");
